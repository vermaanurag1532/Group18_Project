...
#define RCSOFTCHECK(fn) { rcl_ret_t temp_rc = fn; if((temp_rc != RCL_RET_OK)){state = WAITING_AGENT;destroy_entities();}}
enum states {
  WAITING_AGENT,
  AGENT_AVAILABLE,
  AGENT_CONNECTED,
...
{  
  ...
  if (imuTimer != NULL) {
    ...
    imu_msg.linear_acceleration.x = gValue.x*GRAVITY;
    imu_msg.linear_acceleration.y = gValue.y*GRAVITY;
    imu_msg.linear_acceleration.z = gValue.z*GRAVITY;
